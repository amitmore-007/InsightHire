...
from .utils import generate_interview_questions, schedule_meeting, transcribe_audio, generate_interview_analysis, generate_overall_report, send_candidate_email, send_interviewer_email
...
def update_application_status(request, candidate_id):
    ...
    if request.method == "POST":
        ...
        send_mail(
            subject,
            message,
            "insightai.hackathonclub@gmail.com",
            [candidate.user.email],
            fail_silently=False,
        )
